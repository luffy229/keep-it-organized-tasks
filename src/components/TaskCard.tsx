...
const TaskCard = ({ task, onToggleStatus, onDelete, onEdit }: TaskCardProps) => {
  ...
  return (
    <div className={`group bg-white rounded-lg shadow-sm p-2 sm:p-3 transition-all duration-300 ${
      isComplete 
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <h3 className={`text-sm font-medium transition-all duration-300 truncate ${
              isComplete 
        ...
        <div className="flex items-center space-x-1 flex-shrink-0">
          {isComplete ? (
            <div className="px-1.5 py-0.5 rounded-full text-green-700 bg-green-100 text-xs font-medium">
              ✅
            </div>
          ) : (
            <div className="px-1.5 py-0.5 rounded-full text-amber-700 bg-amber-100 text-xs font-medium">
              ⏳
            </div>
          )}
